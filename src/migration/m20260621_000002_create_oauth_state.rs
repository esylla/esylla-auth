...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(Alias::new("state_hash")).string().not_null().primary_key())
                    .col(ColumnDef::new(Alias::new("provider")).string().not_null())
                    .col(ColumnDef::new(Alias::new("pkce_verifier")).string().not_null())
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(Alias::new("auth_oauth_states")).if_exists().to_owned())
            .await
    }
}
